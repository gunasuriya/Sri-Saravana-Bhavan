...
<body style="background-color:yellow;">
		...
		<nav class="navbar bg-2 navbar-inverse mast" style="background-color:purple;text-align:center;">
			<div id="myNavbar" style="text-align:center;">
				...
				<ul class="nav navbar-nav">
					...
					<li><a class="links" style="color:white;" href="index.html"><b>Home</b></a></li>
					...
					<li><a class="links" style="color:#00F3FF;" href="contact.php"><b>Contact Us</b></a></li>
				</ul>
	...
	<div id="mySidenav1" class="sidenav" style="z-index:102;">
		...
		<a class="links1" style="color:white;" href="index.html" onclick="closeNav1()" style="z-index:106;"><b>Home</b></a>
		<a class="links1" style="color:white;" href="menu.html" onclick="closeNav1()"><b>Menu</b></a>
		<a class="links1" style="color:white;" href="online.html" onclick="closeNav1()"><b>Online Ordering</b></a>
		<a class="links1" style="color:white;" href="chef.html" onclick="closeNav1()"><b>Chef</b></a>
		<a class="links1" style="color:#00F3FF;" href="contact.php" onclick="closeNav1()"><b>Contact Us</b></a>
		<br>

	</div>  
		
	<div class="container" id="dai">
		<div class="row">
			<div class="col-md-7" style="padding-top:38px;padding-right:5px;padding-left:10px;">
			<div id="map" class="container" style="margin:auto;border-radius:10px;"></div>
			</div>
			<div class="col-md-5" style="padding-top:20px;background-color:rgba(255,255,0,0.7);">
				<h2 style="font-family:Bungasai;text-align:center;">Contact Us</h2>
				
				<div style="color:purple;font-size:25px;text-align:center;font-family:Bungasai;text-align:center;margin:auto;"><i class="fa fa-phone"></i>  :  9787529102</div><br>
				<form target="_top" action=""   method="post" enctype="multipart/form-data" name="form">
					<input style="color:purple;width:70%;margin:auto;background-color:yellow;border-color:purple;font-family:timesnewroman;" type="text" class="form-control" id="username" placeholder="Name" name="name" required><br>
					<input style="color:purple;width:70%;margin:auto;background-color:yellow;border-color:purple;font-family:timesnewroman;" type="email" class="form-control" id="mail" placeholder="E-mail" name="mailid" required><br>
					<textarea style="color:purple;width:70%;;margin:auto;background-color:yellow;border-color:purple;font-family:timesnewroman;" class="form-control" rows="5" placeholder="Write your comments here" id="comment" name="comments" required></textarea><br>
					<div style="text-align:center;"><input style="background-color:purple;color:yellow;font-family:Bungasai;width:30%;font-size:20px;border-radius:10px;" type="submit" value="Submit" name="submit" class="btn btn-default"/></div>
				</form>
				<div style="padding-top:10px;text-align:center;font-family:Bungasai;"><?php echo $msg; ?></div>
			</div>
		</div>
	</div>
	<br>
	<br>
	<footer class="rev14 foo" style="background-color:purple;margin-top:25px;">
		<h4 style="font-size:18px;font-family:Bungasai;color:white;text-align:center;">Created by <a class="links" style="font-family:thundertitan;font-size:16px;color:black;text-decoration:none;" href="www.google.co.in" target="_blank">BROCODE</a></h4>
	</footer>
	
	<script>
		function myMap() {
			var mapOptions = {
				center: new google.maps.LatLng(11.0924437,77.161453),
				zoom: 17,
				mapTypeId: 'terrain'
			}
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQknNI2DJKGT3TcCrmEFEoXsc4VMeUTVE&callback=myMap"></script>
